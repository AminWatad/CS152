...
%type       <paramdeclarations>  ParamDeclarations
%type       <paramdeclaration>   ParamDeclaration
...
ParamDeclarations : /* empty */                      { $$ = new list<ParamDeclaration*>; }
             | ParamDeclarations ParamDeclaration              { ($$=$1)->push_back($2); }
...
Function     : FUNCTION ID ';'                   
               BEGINPARAMS ParamDeclarations ENDPARAMS
...
ParamDeclaration  : IDs ':' INTEGER ';'           { $$ = new ParamDeclaration($1,$2,$3); }
             | IDs ':' ARRAY '[' NUMBER ']' OF INTEGER ';'
                              { $$ = new ParamDeclaration($1,$2,$3,$4,$5,$6,$7,$8); }
             ;
